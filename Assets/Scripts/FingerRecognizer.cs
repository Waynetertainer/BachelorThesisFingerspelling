...
public class FingerRecognizer : MonoBehaviour
{
    ...
    private AvgFinger avgIndex = new AvgFinger();
    private AvgFinger avgMiddle = new AvgFinger();
    private AvgFinger avgRing = new AvgFinger();
    private AvgFinger avgLittle = new AvgFinger();
    private AvgNum<float> avgThumpSpread = new AvgNum<float>();
    private AvgNum<float> avgThumpRotation = new AvgNum<float>();
    private AvgNum<float> avgThumpStraightness = new AvgNum<float>();
